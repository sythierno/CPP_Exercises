...
template <>
Luma convert<Luma, RGB>(const RGB& x) { return {image_lib::rgb_to_grayscale(x.r, x.g, x.b)}; }
...
RGB operator+(const RGB& lhs, const RGBA& rhs)
{
    ...
    auto rgba = image_lib::mix_color(converted.r, converted.g, converted.b, converted.a, rhs.r, rhs.g, rhs.b, rhs.a);
...
RGBA operator+(const RGBA& lhs, const RGB& rhs)
{
    ...
    auto rgba = image_lib::mix_color(lhs.r, lhs.g, lhs.b, lhs.a, converted.r, converted.g, converted.b, converted.a);
    return {rgba[0], rgba[1], rgba[2], rgba[3]};
}
...
RGB operator+(const RGB& lhs, const RGB& rhs)
{
    ...
    auto rgba = image_lib::mix_color(converted1.r, converted1.g, converted1.b, converted1.a, converted2.r, converted2.g, converted2.b, converted2.a);
    return convert<RGB, RGBA>({rgba[0], rgba[1], rgba[2], rgba[3]});
}
